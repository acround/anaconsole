...
function gif_loadFile($lpszFileName, $iIndex = 0, $fromstring = false)
{
    $gif = new CGIF();

    if (!$gif->loadFile($lpszFileName, $iIndex, $fromstring)) {
        return false;
    }
...
class CGIF
{
    ...
    function loadFile($lpszFileName, $iIndex, $fromstring = false)
    {
        if ($iIndex < 0) {
            return false;
        }
